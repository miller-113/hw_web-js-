...
z = 4;
console.log('y /= x + 5 % z');
y /= x + 5 % z; // а почему при такой форме получается бесконечность, если x=-5 и z=-75. -0.18666666666666668, в пайтоне это нормально обрабатывает =)
console.log('x =', x, 'y =', y, 'z =', z,);
console.log('');
...
z = 4;
console.log('x = y - x++ * z');
x = y - x++ * z; // и теперь у нас 2 бесконечности)
console.log('x =', x, 'y =', y, 'z =', z);
console.log('');
